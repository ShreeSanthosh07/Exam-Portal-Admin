...
const background123 = {
  backgroundImage: "url(https://wallpaperset.com/w/full/e/7/f/16452.jpg)",
  height: "700px",
    ...
    <div style={background123}>
      ...
      <Grid container spacing={1.5} sx={{ marginTop: "60px" }}>
        <Grid item xs={6} md={6} align="center" sx={{ marginTop: "50px" }}>
          <Typography
            variant="h2"
            sx={{ fontSize: "60px", fontWeight: "800", color: "#3e2359" }}
          >
            ONLINE EXAM
          </Typography>
          <br />
        ...
        <Paper style={paperStyle}>
          <Grid
            ...
            sx={{
              backgroundImage:
                "url(https://img.freepik.com/free-photo/final-exam-results-test-reading-books-words-concept_53876-123721.jpg)",
              backgroundRepeat: "no-repeat",
              backgroundSize: "cover",
