      ...
      <AppBar sx={{ background: "#fcfffd" }}>
        <Toolbar>
          ...
          <Tabs sx={{ marginLeft: "auto" }}>
            <Link href="/Home" underline="hover" color="inherit">
              <Tab
                label="Home"
                value="0"
                sx={{ color: "#230233", fontWeight: "800" }}
              />
            </Link>
            ...
            <Link href="/News" underline="hover" color="inherit">
              <Tab label="News" sx={{ color: "#230233", fontWeight: "800" }} />
            </Link>
          ...
          <Link href="/signup" underline="hover" color="inherit">
            <Button
              variant="contained"
              sx={{ backgroundColor: "#cb93e6", marginRight: "5px" }}
            >
              Sign Up
            </Button>
          </Link>
          <Link href="/signIn" underline="hover" color="inherit">
            <Button variant="contained" sx={{ backgroundColor: "#cb93e6" }}>
              Sign In
            </Button>
          </Link>
        </Toolbar>
